...
object Config {
    ...
    private fun loadFromEnv() {
        ...
        val timeout = System.getenv("KERUTA_TIMEOUT")?.let { 
            Duration.parse("PT${it}") 
        } ?: globalConfig.api.timeout
        ...
        val maxSize = System.getenv("KERUTA_MAX_FILE_SIZE")?.toLongOrNull()?.let { 
            it * 1024 * 1024 
        } ?: globalConfig.artifacts.maxSize
